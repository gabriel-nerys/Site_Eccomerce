    ...
    <div class="container mt-4">
        <div class="row align-items-center">
            <div class="col-md-10 mx-auto col-lg-5">
                <form name="incluirProd" enctype="multipart/form-data" class="p-4 p-md-5 border rounded-3 bg-light" id="incluirProd" method="post" action="alterar.php?cd_altera=<?php echo $cd;?>"  >
                    ...
                    <div class="mb-3">
                        ...
                        <input name="txtnome" value="<?php echo $exibe['nm_tenis']; ?>" type="text" class="form-control" id="txtnome" required>
                    </div>
                    <div class="mb-3">
                        <label for="txtemail" class="form-label">Marca</label>
                        <select name="sltmarc" id="sltmarc" class="form-control">
                    ...
                    <div class="mb-3">
                        ...
                        <input name="txttamanho" value="<?php echo $exibe['no_med']; ?>" autocomplete="off" maxlength="2" type="text" class="form-control" id="txttamanho" required >
                    </div>
                    <div class="mb-3">
                        <label  for="txtpreco" class="form-label">Preço</label>
                        <input name="txtpreco" value="<?php echo $exibe['vl_preco']; ?>" type="text" class="form-control" required id="txtpreco">
                    </div>                    
                    <div class="mb-3">
                        <label for="estoque">Estoque</label>
                        <input name="txtestoque" value="<?php echo $exibe['qt_estoque']; ?>" type="text" class="form-control" id="txtestoque" required>
                    </div>
                    <div class="mb-3">
                        <label for="cidade">Descrição</label>
                        <input name="txtdescricao" value="<?php echo $exibe['ds_resumo_tenis']; ?>" rows="5" type="text" class="form-control" id="txtdescricao" required>
                    </div>
                    <div class="mb-3">
                        <label for="cep">Foto principal</label>
                        <input name="txtfoto" value="<?php echo $exibe['ds_tenis_img']; ?>" accept="img/*" type="file" class="form-control" id="txtfoto">
                    </div>
